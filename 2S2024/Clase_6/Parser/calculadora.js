...
function peg$parse(input, options) {
  ...
  var peg$f4 = function(exp, instrTrue, instrFalse) {
    return new InstruccionIf(exp,instrTrue, instrFalse !== null ? instrFalse : null);
};
  var peg$f5 = function(instrFalse) {
      return instrFalse;
    };
  var peg$f6 = function(left, expansion) { 
  ...
  var peg$f9 = function(num) {return new Aritmeticas("-", null, num)};
  var peg$f10 = function(num) {return new Value(parseInt(num.join(""),10))};
  var peg$f11 = function(exp) {return exp};
  var peg$f12 = function(bool) {return new Value(bool==="True"?true:false)};
  var peg$f13 = function(chars) {
      return new Value(chars.join(""))
    };
  var peg$f14 = function(id) {return new Identificador(id.join(""))};
