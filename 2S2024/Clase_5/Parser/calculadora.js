...
function peg$parse(input, options) {
  ...
  var peg$f0 = function(exp) {return new Print(exp)};
  var peg$f1 = function(id, exp) {return new Declaracion(id.join("") ,exp)};
  ...
  var peg$f5 = function(num) {return new Aritmeticas("-", null, num)};
  var peg$f6 = function(num) {return new Value(parseInt(num.join(""),10))};
  var peg$f7 = function(exp) {return exp};
  var peg$f8 = function(bool) {return new Value(bool==="True"?true:false)};
  var peg$f9 = function(chars) {
      return new Value(chars.join(""))
    };
  var peg$f10 = function(id) {return new Identificador(id.join(""))};
