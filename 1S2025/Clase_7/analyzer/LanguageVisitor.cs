...
public interface ILanguageVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitArryDclStmt([NotNull] LanguageParser.ArryDclStmtContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitSliceDclStmt([NotNull] LanguageParser.SliceDclStmtContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitAppendSliceStmt([NotNull] LanguageParser.AppendSliceStmtContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitArrayDcl([NotNull] LanguageParser.ArrayDclContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="LanguageParser.list_values"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitList_values([NotNull] LanguageParser.List_valuesContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitArrayAccessExpr([NotNull] LanguageParser.ArrayAccessExprContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitArrAccess([NotNull] LanguageParser.ArrAccessContext context);
}
